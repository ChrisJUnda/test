            ...
            <div className="flex flex-col">
              <div className="flex flex-col">
                ...
                <p className="font-normal text-sm text-gray-700 mb-1 pl-2">
                  ...
                  College due to this reuse of books will be there beneficial
                  for environment also indirectly helps increase communication
              ...
              <div className="flex flex-col">
                ...
                <p className="font-normal text-sm text-gray-700 mb-1 pl-2">
                  it’s a web application which helps you to book your slot for
                  your car just like booking a movie ticket from home.
                </p>
              </div>
            </div>
          </div>
