...
//               <p className="font-medium text-sm">Most advanced language A.I</p>
//             </div>
//           </div>
//         </a>
...
//             posts in minutes, provides content optimization advice, and works
//             with a plagiarism-free rule.
//           </p>
...
//             crafts high-quality content at a fraction of the cost. This advanced
//             solution eliminates the need for manual writing and allows users to
//             effortlessly generate content in a few clicks.
//           </p>
//           <ul className="flex flex-wrap items-center justify-start text-sm gap-2">
//             <li
//               title="Pricing type"
...
//               <p className="font-medium text-sm">Your Social Media Superhero</p>
//             </div>
//           </div>
//         </a>
//         <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
//           <p className="text-gray-600 two-lines">
//             Publer is a robust social media management platform offering a range
//             of features including post scheduling, collaboration tools,
//             analytics, and AI assistance to supercharge your social media
...
//         <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
//           <p className="text-gray-600 two-lines">
//             Anyword is an AI-powered platform trusted by marketing teams across
//             the globe to generate, score, and rank content based on predicted
//             performance. With features like Custom Scoring AI models, Brand
//             Messaging Management, and a Performance Boost Chrome Extension,
//             Anyword provides highly personalized and effective content for every
//             channel.
//           </p>
//           <ul className="flex flex-wrap items-center justify-start text-sm gap-2">
//             <li
...
//         <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
//           <p className="text-gray-600 two-lines">
//             BlogSEO AI revolutionizes SEO writing. Stay at the top of your SEO
//             game with this automated writing tool that generates high-performing
//             blog content. It also offers keyword research, internal linking
...
//               <p className="font-medium text-sm">AI Communication Assistant</p>
//             </div>
//           </div>
//         </a>
//         <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
              ...
              <Link className="relative" to="/annuncio">
                <div className="relative w-full aspect-video">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
                    ...
                    <p className="font-medium text-sm">Age:  30</p>
                    <p className="font-medium text-sm">c@mail.com</p>
                  </div>
                </div>
              </Link>
              <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
                <p className="text-gray-600 two-lines">
                  This is an AI tool created for ciao. It provides
                  personalized content and services to help you generate amazing
                  posts.
                </p>
                <ul className="flex flex-wrap items-center justify-start text-sm gap-2">
                  <li
