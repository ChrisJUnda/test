...
function Annuncio() {
  ...
  >
    <div className="p-4 md:p-12 text-center lg:text-left">
      ...
      />
      <h1 className="text-3xl font-bold pt-8 lg:pt-0">Software developer</h1>
      ...
      <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
        ...
        Anni di esperienza richiesti:  <span class="ml-5"> minimo 5</span>
      </p>
      <p className="pt-2 lg:text-sm flex items-center justify-center lg:justify-start">
        <svg
          className="h-4 fill-current text-green-700 pr-4"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
      ...
      ricerchiamo una figura fortemente orientata al lavoro di squadra
      </p>
